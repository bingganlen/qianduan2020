...
(function (factory) {
  ...
  var Ripples = function (el, options) {
      ...
      for (var i = 0; i < 2; i++) {
          ...
          gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
          gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
          gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, this.resolution, this.resolution, 0, gl.RGBA, config.type,
              null);
  ...
  Ripples.prototype = {
      ...
      loadImage: function () {
          ...
          image.onload = function () {
              ...
              var wrapping = (isPowerOfTwo(image.width) && isPowerOfTwo(image.height)) ? gl.REPEAT :
                  gl.CLAMP_TO_EDGE;
      ...
      computeTextureBoundaries: function () {
          ...
          if (isPercentage(backgroundX)) {
              backgroundX = container.left + (container.width - backgroundWidth) * parseFloat(
                  backgroundX) / 100;
          } else {
          ...
          if (isPercentage(backgroundY)) {
              backgroundY = container.top + (container.height - backgroundHeight) * parseFloat(
                  backgroundY) / 100;
          } else {
  ...
  $.fn.ripples = function (option) {
      ...
      return this.each(function () {
          var $this = $(this),
              ...
              options = $.extend({}, Ripples.DEFAULTS, $this.data(), typeof option == 'object' &&
                  option);
