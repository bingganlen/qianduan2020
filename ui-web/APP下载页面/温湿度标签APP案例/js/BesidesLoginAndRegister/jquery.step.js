...
(function (factory) {
    ...
    if (typeof define === 'function') {
      ...
      define.cmd&&define('jquery-step', ['BesidesLoginAndRegister/jquery'], function (require, exports, moudles) {
            var $=require("BesidesLoginAndRegister/jquery");
            factory($);
            return $;
        });
      define.amd&&define(['BesidesLoginAndRegister/jquery'], factory);
    } else {
